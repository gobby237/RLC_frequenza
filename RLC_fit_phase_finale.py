...
# --- Scansione del chi2 ---
n_sigma_scan = 2   # semiampiezza in unita di sigma del fit
...
params = {
    'legend.fontsize': 10 + FONT_INCREMENT,
    ...
    'legend.edgecolor': 'w',
    'figure.figsize': (6, 4),
    'axes.labelsize': 10 + FONT_INCREMENT,
    'figure.titlesize': 14 + FONT_INCREMENT,
    'axes.titlesize': 12 + FONT_INCREMENT,
    'xtick.labelsize': 10 + FONT_INCREMENT,
    'ytick.labelsize': 10 + FONT_INCREMENT,
    'lines.linewidth': 1,
    'text.usetex': True,
...
#     per Q piccolo il passaggio da +pi/2 a -pi/2 e piu graduale.
...
# ============================================================
# GRAFICO 0: dati grezzi Delta t in ns
# ============================================================
fig, ax = plt.subplots(1, 1, figsize=(6, 4), constrained_layout=True)
ax.errorbar(fr_all, Dt_ns, yerr=eDt_ns, fmt='o', ms=3,
            color=DT_COLOR, ecolor=DT_COLOR, elinewidth=0.8, capsize=2,
            label=r'$\Delta t$')
ax.axhline(0, color='gray', ls='dotted', lw=0.8)
ax.set_xlabel(r'Frequenza [kHz]')
ax.set_ylabel(r'$\Delta t$ [ns]')
ax.legend(loc='best', prop={'size': LEGEND_BIG})
ax.set_title(r'Dati grezzi del ritardo temporale')

plt.savefig(file.replace('.txt', '') + '_0_Dt.png',
